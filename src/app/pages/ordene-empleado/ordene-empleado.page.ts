...
@Component({
  selector: 'app-ordene-empleado',
  templateUrl: './ordene-empleado.page.html',
  styleUrls: ['./ordene-empleado.page.scss'],
})
export class OrdeneEmpleadoPage implements OnInit {
  ...
  registrarOrden(){
    ...
    this.db.finalizarOrdenEEmpleado(this.nombreCliente); 
  }else{

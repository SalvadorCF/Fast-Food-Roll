...
@Component({
  selector: 'app-verorden-empleado',
  templateUrl: './verorden-empleado.page.html',
  styleUrls: ['./verorden-empleado.page.scss'],
})
export class VerordenEmpleadoPage implements OnInit {
